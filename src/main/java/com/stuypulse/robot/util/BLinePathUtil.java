...
public class BLinePathUtil {
    ...
    public BLineAutonConfig(String name, Function<String[], Command> auton, double waitTimeOne, double waitTimeTwo, String... paths) {
        this.name = name;
        this.auton = auton;
        this.paths = paths;
    ...
    public BLineAutonConfig register(SendableChooser<Command> chooser) {
        chooser.addOption(name, buildCommand());
        return this;
    }

    public BLineAutonConfig registerDefault(SendableChooser<Command> chooser) {
