...
public class RobotContainer {
    ...
    public void configureAutons() {
        ...
        "Right Chezy Abrupt Score To Hub", "Right Chezy Hub To Transition", "Right Copy Chezy NZ To Bump", "Right Transition To Shoot", "Right Bump Score", "Right Bump Score End To NZ");
