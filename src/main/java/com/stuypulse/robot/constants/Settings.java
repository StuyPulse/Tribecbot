...
public interface Settings {
    ...
    public interface Handoff {
        ...
        public final double HANDOFF_STOP = 0.0;
        public final double HANDOFF_MAX = 4800.0;
        public final double HANDOFF_REVERSE = -500.0;
        public final double RPM_TOLERANCE = 200.0;
    ...
    public interface Intake {
        public final double GEAR_RATIO = (32.0 / 18.0) * (64.0 / 18.0) * (60.0 / 9.0);

        public final Rotation2d PIVOT_STOW_ANGLE = Rotation2d.fromDegrees(90.0);
        public final Rotation2d PIVOT_INTAKE_OUTAKE_ANGLE = Rotation2d.fromDegrees(0.0);
        ...
        public final Rotation2d PIVOT_ANGLE_OFFSET = new Rotation2d();
        public final Rotation2d PIVOT_MAX_ANGLE = Rotation2d.fromDegrees(190.0);
        public final Rotation2d PIVOT_MIN_ANGLE = Rotation2d.fromDegrees(80.0);

        public final Rotation2d PIVOT_MAX_VEL = Rotation2d.fromDegrees(300.0);
        public final Rotation2d PIVOT_MAX_ACCEL = Rotation2d.fromDegrees(300.0);
    }
    ...
    public interface Spindexer {
        public final double FORWARD_SPEED = 6000.0;
        public final double REVERSE_SPEED = -6000.0;
        public final double STOP_SPEED = 0.0;

        public final double RPM_TOLERANCE = 400.0;

        public interface Constants {
            public final double GEAR_RATIO = 8.0 / 1.0;
        }
    }
