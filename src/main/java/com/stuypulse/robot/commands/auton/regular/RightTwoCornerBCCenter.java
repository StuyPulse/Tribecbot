...
public class RightTwoCornerBCCenter extends SequentialCommandGroup {
    
    public RightTwoCornerBCCenter(PathPlannerPath... paths) {
        ...
        addCommands(
            ...
            new ParallelCommandGroup(
                ...
                new SpindexerRun(),
                new WaitCommand(0.5)
                    .andThen(new IntakeAutoDigest().withTimeout(4.0)), //cut this down
