...
public class RightTwoCornerBCNewSix extends SequentialCommandGroup {
    //this one removes pathfinder,  removes is hopper empty, and puts timeout only on the path
    public RightTwoCornerBCNewSix(PathPlannerPath... paths) {
        ...
        addCommands(
            ...
            new ParallelCommandGroup(
                CommandSwerveDrivetrain.getInstance().followPathCommand(paths[2]).withTimeout(2.0),// uncomment if we have issues
                new HandoffRun(),
                new SpindexerRun(),
