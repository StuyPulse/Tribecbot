...
public class RightTwoCornerShallow extends SequentialCommandGroup {
    
    public RightTwoCornerShallow(PathPlannerPath... paths) {
        ...
        addCommands(
            ...
            new ParallelCommandGroup(
                ...
                new SpindexerRun(),
                new WaitCommand(0.5)
                    .andThen(new IntakeAutoDigest().until(() -> Superstructure.getInstance().isHopperEmpty()).withTimeout(4.0)),
            ...
            new ParallelCommandGroup(
                ...
                new SpindexerRun(),
                new WaitCommand(0.5)
                    .andThen(new IntakeAutoDigest().withTimeout(15.0)),
