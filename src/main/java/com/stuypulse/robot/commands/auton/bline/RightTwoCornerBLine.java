...
public class RightTwoCornerBLine extends SequentialCommandGroup {

    private static final double HANDOFF_THRESHOLD_METERS = 0.15; // tune per-path

    public RightTwoCornerBLine(String... pathNames) {
        ...
        addCommands(
            ...
            .alongWith(new WaitCommand(0.2).andThen(new IntakeDeploy())),

            // Trip 1 To Score
            followUntil(swerve, pathNames[1], HANDOFF_THRESHOLD_METERS, pose -> {})
            .alongWith(new SuperstructureAutoInterpolation()),
